...
Use this plugin in combination with the [@supademo/rrweb-plugin-sequential-id-record](../rrweb-plugin-sequential-id-record) plugin to record and replay events with a sequential id.
See the [guide](../../../guide.md) for more info on rrweb.

## Installation

```bash
npm install @supademo/rrweb-plugin-sequential-id-replay
```
...
import { getReplaySequentialIdPlugin } from '@supademo/rrweb-plugin-sequential-id-replay';
