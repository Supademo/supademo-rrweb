(function (g, f) {if ("object" == typeof exports && "object" == typeof module) {module.exports = f();} else if ("function" == typeof define && define.amd) {define("rrwebPluginCanvasWebRTCRecord", [], f);} else if ("object" == typeof exports) {exports["rrwebPluginCanvasWebRTCRecord"] = f();} else {g["rrwebPluginCanvasWebRTCRecord"] = f();}}(typeof self !== 'undefined' ? self : typeof globalThis !== 'undefined' ? globalThis : this, () => {var exports = {};var module = { exports };
"use strict";
