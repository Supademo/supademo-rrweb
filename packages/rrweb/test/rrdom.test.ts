...
import type { styleDeclarationData, styleSheetRuleData } from '@supademo/rrweb-types';
import { createMirror, Mirror as NodeMirror } from '@supademo/rrweb-snapshot';
import type { ReplayerHandler } from '@supademo/rrdom';
